...
Difference between graphs in first row is the different in number of x levels. Difference between graphs in second row is the different in number of facet levels. For both the cases, the shape and scale of the distribution remains the same. But flipping the x-axis and facet levels change the distribution even when all levels are drawn from same distribution.
