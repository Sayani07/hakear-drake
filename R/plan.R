the_plan <-
  drake_plan(
    ...
    norm_data_n = create_sim_n(norm_data1, nsim = 500),
            # plot distribution of nsim norm_max

    plot_data_n = plot_sim_n(norm_data_n),
              # analysis file
              target_name = target(
                command = {
