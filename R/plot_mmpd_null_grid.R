...
##' @author Sayani Gupta
##' @export
plot_mmpd_null_grid <- function(mmpd_dist_null_data, mmpd_null_orig_data) {
  ...
  ggplot() + 
    geom_histogram(data = mmpd_dist_null_data, aes(x = mmpd))  + 
    geom_vline(data = mmpd_null_orig_data, aes(xintercept = mmpd),colour = "red") +
